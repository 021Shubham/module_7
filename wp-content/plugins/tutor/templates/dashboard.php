				...
				<div class="tutor-d-flex tutor-align-center">
					...
					if ( function_exists( 'tutor_pro' ) ) : ?>
						...
						<?php else : 
							global $wp;
							?>
							<!-- <?php //if($wp->request!='dashboard/my-courses'){?>
							<a href="<?php //echo site_url('dashboard/my-courses/'); ?>" class="tutor-btn tutor-btn-outline-primary">
								<i class="tutor-icon-gear tutor-my-n4 tutor-mr-8"></i>
								<?php //esc_html_e( 'Manage Courses', 'tutor' ); ?>
							</a>
							<?php //} ?> -->

							<?php //echo str_repeat('&nbsp',5);?>
							<?php //if($wp->request=='dashboard/my-courses'){?>
							<a href="<?php echo esc_url( admin_url( "post-new.php?post_type=$course_type" ) ); ?>" class="tutor-btn tutor-btn-outline-primary" target="_blank">
