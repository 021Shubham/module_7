						...
						<div class="tutor-course-topic-item tutor-course-topic-item-quiz<?php echo ($currentPost->ID == get_the_ID()) ? ' is-active' : ''; ?>" data-quiz-id="<?php echo $quiz->ID; ?>">
							<a href="<?php echo $show_permalink ? esc_url( get_permalink( $quiz->ID ) ) : '#'; ?>" data-quiz-id="<?php echo $quiz->ID; ?>">
								...
								<div class="tutor-d-flex tutor-ml-auto tutor-flex-shrink-0">
									...
									$has_attempt = tutor_utils()->get_passed(get_current_user_id(), $quiz->ID);
									// var_dump($has_attempt);exit;
									if ($time_limit) {
...
<style>
	.tutor-course-topic-single-footer.custom-prev-next{
		position: fixed;
		bottom: 0;
		left: 0;
		width: 400px;
...
<div class="tutor-course-topic-single-footer tutor-px-32 tutor-py-12 tutor-mt-auto custom-prev-next">
