...
$page_tabs = array(
	// 'enrolled-courses/all-courses'    	 => __('All Courses', 'tutor'),
...
$courses_list_array = array(
	// 'enrolled-courses/all-courses'    => tutor_utils()->get_all_courses_by_user(null, $offset, $per_page),
...
$full_courses_list_array = array(
	// 'enrolled-courses/all-courses'    => tutor_utils()->get_all_courses_by_user(),
