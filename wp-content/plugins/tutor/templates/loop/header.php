...
<div class="tutor-course-bookmark">
    <?php
		...
		echo '<a href="javascript:; " onclick="window.location.reload(true);" class="'. esc_attr( $action_class ) .' save-bookmark-btn tutor-iconic-btn tutor-iconic-btn-secondary" data-course-id="'. esc_attr( $course_id ) .'">
