...
<div class="tutor-mb-32" style="display:none;">
...
<div class="tutor-row tutor-mb-32">
    <div class="tutor-col-12 tutor-mb-12">
        <label class="tutor-fs-6 tutor-fw-medium tutor-color-black"><?php _e( 'Total Course Duration', 'tutor' ); ?></label>
    </div>
    ...
    <div class="tutor-col-6 tutor-col-sm-4 tutor-col-md-3">
        ...
        <span class="tutor-fs-7 tutor-color-muted"><?php _e( 'Minute', 'tutor' ); ?></span>
    </div>
