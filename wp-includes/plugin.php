...
function do_action( $hook_name, ...$arg ) {
	// if ($hook_name == 'template_redirect') {
	// 	print('<pre>$hook_name new : '.print_r($hook_name, true).'</pre>');
	// 	die();
	// }

	global $wp_filter, $wp_actions, $wp_current_filter;

	// print('<pre>$wp_actions: '.print_r($wp_actions, true).'</pre>');
	// print('<pre>$wp_filter: '.print_r($wp_filter, true).'</pre>');
	// print('<pre>$wp_current_filter: '.print_r($wp_current_filter, true).'</pre>');
	// die();
	...
	// print('<pre>$wp_actions after: '.print_r($wp_actions, true).'</pre>');
	// die();
	...
	// if ($hook_name == 'template_redirect') {
	// 	// print('<pre>$wp_filter[ $hook_name ] after: '.print_r($wp_filter[$hook_name], true).'</pre>');
	// 	print('<pre>$arg: '.print_r($arg, true).'</pre>');
	// 	print('<pre>$wp_current_filter after: '.print_r($wp_current_filter, true).'</pre>');
	// 	die();
	// }
